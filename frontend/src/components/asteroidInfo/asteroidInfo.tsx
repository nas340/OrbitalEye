...
const AsteroidInfo = () => {
  ...
  return (
    <div className='flex'>
      {response && (
        <div className="overflow-auto explanation-scrollbar max-w-[80vw] md:max-w-[60vw] lg:max-w-[50vw] glass">
          <div className="sticky top-0  bg-zinc-900 w-full text-center p-2">
            Asteroid Info
          </div>
          <div className="flex mt-1">
            <div className="max-h-[80vh] basis-2/5 overflow-auto explanation-scrollbar">
              {response.map(val => (
                <>
                  <button
            ...
            <div className=" max-h-[80vh] basis-3/5 overflow-auto">
              {!selectedAsteroid ? (
                <div className="flex justify-center items-center italic font-thin">
